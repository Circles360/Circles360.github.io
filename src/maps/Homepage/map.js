                ...
                <Container style={containerStyle}>
                    <Header as="h1" style={{ transition: "2s ease", position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", fontSize: "96px" }} textAlign="center">
                        ...
                        <Header.Subheader style={{ transition: "2s ease", fontSize: "18px" }}>
                            ...
                            <div>
                                <Message warning>
                                    Please visit the new Circles being worked on by the DevSoc team at <a href="https://circles.devsoc.app" target="_blank" rel="noopener noreferrer">https://circles.devsoc.app</a>
                                </Message>
                            </div>
                        </Header.Subheader>
                    </Header>
